/**
 * Created by tiger on 2015/12/18.
 */
'use strict';
var basketball = angular.module("live1.basketball");

/*****************************国际化*******************************/
basketball.config(['$translateProvider', function ($translateProvider) {
    var translationVI = {
       "HEAD_TITLE":	"Tỷ Số Nhất bản màn hình cảm ứng",
       "Basketball_TITLE":	"Tỷ số bống rổ",
       "TABS_IMMEDIATE":	"Live",
       "TABS_RESULTS":	"Kết quả",
       "TABS_SCHEDULE":	"Lịch trình",
       "TABS_ATTENTION":	"Chú ý",
       "ODDS_SHOW":	"Nhắctỷ lệ ",
       "FILTERING_SHOW":	"Nhắc nhở giải đấu",
        "HOT_FILTERING":	"Giải đấu hot",
        "OTHER_FILTERING":	"Giải đấu khác",
        "BUTTON_SUBMIT":	"OK",
        "BUTTON_CANCEL":	"Hủy",
        "FILTERING":	"Chọn",
        "SETTING":	"Cài đặt bóng rổ",
        "FILTERING_MATCH":	"Chọn Bóng rổ",
        "RESET_MATCH":	"Đạt lại",
        "HOT_MATCH":	"Hot",
        "SELECT_ALL_MATCH":	"Chọn hết",
        "DESEELCT_MATCH":	"Chọn ngược",
        "ODDS_ASIAN":	"Kèo châu Á",
        "ODDS_SIZE":	"kèo tài xỉu",
        "ODDS_EUROPE":	"Tỷ lệ Châu Âu",
        "ODDS_HIDE":	"Không",
        "MEDAL_SCORE":	"Tổng số HT/FT",
      "TOTAL_SCORE":	"khoảng cách tông số",
      "SINGLE_QUARTER":	"ghi số thời gian duy nhất",
      "HOST_RANKING":	"Xếp hạng",
      "NO_IMMEDIATE_MATCHES":	"Cuộc giải đáu tìm theo yêu cầu bạn chọn là có 0 trận.",
      ...
      "ERROR_DAY":	"Lỗi hệ thống, không có thể đọc ngày !",
        ...
        "STATE_CANCEL":	"Hủy",
        "STATE_UNDETERMINED":	"Đang chờ",
        "STATE_INTERRUPT":	"Break",
        "STATE_DELAY":	"Hoãn",
        "BA_TOTAL":	"Tổng" ,
        "BA_SPREAD":	"khoảng cách",
        "BA_RESULTS":	"kết quả",
        "BA_HOMETEAM":	"đội chủ"
    }
    var translationTH = {
      ...
      ODDS_SHOW:	"เคล็ดลับออดซ ",
      FILTERING_SHOW:	"เคล็ดลับของเกม",
      HOT_FILTERING:	"เกมยอดนิยม",
      OTHER_FILTERING:	"เกมอื่นๆ",
      BUTTON_SUBMIT:	"ยืนยัน",
      BUTTON_CANCEL:	"ยกเลิก",
      FILTERING:	"คัดเลือก",
      SETTING:	"การตั้งค่าบาสเกตบอล",
      FILTERING_MATCH:	"การเลือกบาสเกตบอล ",
      RESET_MATCH:	"การตั้งค่าใหม่",
      HOT_MATCH:	"ยอดนิยม",
      ...
      ODDS_HIDE:	"ไม่มี",
      MEDAL_SCORE:	"คะแนนรวมครึ่งเวลา/เต็มเวลา",
      TOTAL_SCORE:	"ผลต่างของคะแนนรวม",
      SINGLE_QUARTER:	"คะแนนต่อควอเตอร์",
      HOST_RANKING:	"จัดอันดับ",
      NO_IMMEDIATE_MATCHES:	"เกมทั้งหมดที่คุณเหลือกมี 0 เกม",
      NO_INIT_IMMEDIATE_MATCHES:	"ไม่มีเกม",
      NO_ATTENTION_MATCHES:	"ยังไม่มีเกม",
      ...
      STATE_THIRD:	"3rd",
      STATE_FOURTH:	"4th",
      STATE_FIRSTHALF:	"ครึ่ง1st",
      STATE_MIDFIELD:	"ครึ่งเวลา",
      STATE_LASTHALF:	"ครึ่ง1st",
      STATE_OVERTIME:	"OT1",
      STATE_OVERTIME2:	"OT2",
      STATE_OVERTIME3:	"OT3",
      STATE_FINISH:	"จบ",
    ...
    var translationsEN = {
      ...
      "FILTERING":	"Filtering",
      "SETTING":	"Settings",
      "FILTERING_MATCH":	"Basketball Filtering",
      "RESET_MATCH":	"Reset",
      "HOT_MATCH":	"Hot",
      ...
      "ODDS_EUROPE":	"Odds",
      "ODDS_HIDE":	"No",
      "MEDAL_SCORE":	"Half/Full Time Score",
      "TOTAL_SCORE":	"Total Score Difference",
      "SINGLE_QUARTER":	"Quarter Score",
      "HOST_RANKING":	"Ranking",
      ...
      "STATE_THIRD":	"3rd",
      "STATE_FOURTH":	"4th",
      "STATE_FIRSTHALF":	"lst Half",
      "STATE_MIDFIELD":	"Half Time",
      ...
      "BA_TOTAL":	"Total",
      "BA_SPREAD":	"Difference",
      "BA_RESULTS":	"W/L",
      "BA_HOMETEAM":	"Home Team"
    }
    var translationsZH = {
        "HEAD_TITLE": "【热门篮球比分】直播热门篮球赛事-一比分",
        "BASKETBALL_KEYWORDS": "热门篮球比分,热门篮球赛事",
        "BASKETBALL_DESCRIPTION": "一比分热门篮球比分直播中心免费为您提供最全的热门篮球比分数据，您查询热门篮球比分数据的最好去处",
    ...
    var translationsZH_HANS = {
        "HEAD_TITLE": "【熱門籃球比分】直播熱門籃球賽事-一比分",
        "BASKETBALL_KEYWORDS": "熱門籃球比分,熱門籃球賽事",
        "BASKETBALL_DESCRIPTION": "一比分熱門籃球比分直播中心免費為您提供最全的熱門籃球比分數據，您查詢熱門籃球比分數據的最好去處",
    ...
    $translateProvider.translations('vi',translationVI);
...
/*****************************服务层*******************************/
//即时比赛
basketball.factory("FindLiveService", [
    "$resource",
    function ($resource) {
...
//即时服务
basketball.factory("FindLiveServiceFactory", [
    "FindLiveService",
    function (FindLiveService) {
        ...
        obj.loadFindLiveMatchData = function ($scope, $cookieStore, $timeout) {
            ...
            FindLiveService.get({lang: $scope.getLanguage(),timeZone:timezone}, function (data) {
                var dayWeek = null;
...
//赛果服务
basketball.factory("ResultServiceFactory", [
    "ResultService",
    function (ResultService) {
        ...
        obj.loadResultMatchData = function ($scope, $cookieStore, flag) {
          ...
          var timezone = window.localStorage.getItem("timezone") || $scope.timezone;
            ResultService.get({lang: $scope.getLanguage(),timeZone:timezone}, function (data) {
                var index = 0;
                var dayWeek = null;
...
//赛程
basketball.factory("ScheduleService", [
    "$resource",
    function ($resource) {
...
//赛程服务
basketball.factory("ScheduleServiceFactory", [
    "ScheduleService",
    function (ScheduleService) {
        ...
        obj.loadScheduleMatchData = function ($scope, $cookieStore, flag) {
          ...
          var timezone = window.localStorage.getItem("timezone") || $scope.timezone;
            ScheduleService.get({lang: $scope.getLanguage(),timeZone:timezone}, function (data) {
                var index = 0;
                var dayWeek = null;
                $scope.gameList = data.matchFilter;
...
//关注
basketball.factory("AttentionService", [
    "$resource",
    function ($resource) {
...
//关注服务
basketball.factory("AttentionServiceFactory", [
    "AttentionService",
    function (AttentionService) {
        ...
        obj.loadAttentionMatchData = function ($scope, $cookieStore, $timeout, baAttentionThirdIds) {
            var attentionThirdIdArr = $scope.getAttentionThirdIdArrFromCookie();
          var timezone = window.localStorage.getItem("timezone") || $scope.timezone;
            AttentionService.get({lang: $scope.getLanguage(), favourite: baAttentionThirdIds,timeZone:timezone}, function (data) {
...
//websocket
var connection = null;
basketball.factory('WebSocket', function () {
    return {
...
/*****************************控制器*******************************/
basketball.controller("BasketballController", [
    "$http",
    "$scope",
    "$document",
    '$window',
