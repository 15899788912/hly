 ...
 */
var regCon = ['$interval','$scope','accountFactory',function($interval,$scope,accountFactory){
  ...
  $scope.sendPic = function() {
    if (!isEmpty($scope.account)) {
      var imgurl = "http://192.168.31.18:8080/mlottery/core/h5UserCenter.findVerifyCode.do?account="+$scope.account;
  ...
  $scope.changeCode = function() {
    if (!isEmpty($scope.account)) {
      var imgurl = "http://192.168.31.18:8080/mlottery/core/h5UserCenter.findVerifyCode.do?account="+$scope.account +"&c="+Date.now();
